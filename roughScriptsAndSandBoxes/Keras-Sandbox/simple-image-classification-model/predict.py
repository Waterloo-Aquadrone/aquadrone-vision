...
# Questions: 	What if we wanted to make predictions on images after our network has already been trained
#				How would we load the model from disk? How can we load an image and them preprocess it for classification?
